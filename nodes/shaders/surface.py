...
class AiAmbientOcclusion(bpy.types.Node, base.ArnoldNode):
    ...
    samples: IntProperty(name="Samples", min=1, default=3)
    spread: FloatProperty(name="Spread", min=0, max=1, default=1)
    near_clip: FloatProperty(name="Near Clip", min=0)
    far_clip: FloatProperty(name="Far Clip", min=0, default=5)
