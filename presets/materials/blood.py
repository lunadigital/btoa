...
node.inputs[1].default_value = (0.43248310685157776, 0.0, 0.0)
...
node.inputs[10].default_value = 0.10000000149011612
...
node.inputs[19].default_value = (0.43199998140335083, 0.0, 0.0)
node.inputs[20].default_value = (0.19999994337558746, 0.19999994337558746, 0.19999994337558746)
...
node.inputs[31].default_value = 2.0
