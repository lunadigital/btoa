...
node.inputs[1].default_value = (0.04899970814585686, 0.0, 0.048999883234500885)
node.inputs[2].default_value = 0.0
node.inputs[3].default_value = 0.0
node.inputs[4].default_value = 0.0
node.inputs[5].default_value = (0.012009130790829659, 0.012009130790829659, 0.012009130790829659)
node.inputs[6].default_value = 0.6930000185966492
node.inputs[7].default_value = 1.0
node.inputs[8].default_value = 0.18799999356269836
...
node.inputs[25].default_value = 1.0
node.inputs[26].default_value = (0.40400001406669617, 0.057999998331069946, 1.0)
