...
node.inputs[1].default_value = (0.04899999871850014, 0.0, 0.04899999871850014)
node.inputs[2].default_value = 0.0
node.inputs[3].default_value = 0.0
node.inputs[4].default_value = 0.0
node.inputs[5].default_value = (0.012009000405669212, 0.012009000405669212, 0.012009000405669212)
...
node.inputs[32].default_value = 1.0
node.inputs[33].default_value = (0.40400001406669617, 0.057999998331069946, 1.0)
