...
node.inputs[1].default_value = (1.0, 0.48100000619888306, 0.8640000224113464)
...
node.inputs[10].default_value = 0.800000011920929
node.inputs[11].default_value = (1.0, 0.48100000619888306, 0.8640000224113464)
node.inputs[12].default_value = 1.0
node.inputs[13].default_value = (1.0, 0.48100000619888306, 0.8640000224113464)
...
node.inputs[19].default_value = (1.0, 0.48100000619888306, 0.8640000224113464)
node.inputs[20].default_value = (1.0, 1.0, 1.0)
