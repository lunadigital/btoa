...
node.inputs[1].default_value = (0.8000000715255737, 0.8000000715255737, 0.8000000715255737)
...
node.inputs[26].default_value = (0.7237211465835571, 0.7237211465835571, 0.7237211465835571)
node.inputs[27].default_value = 0.30000001192092896
node.inputs[28].default_value = 0.9599999785423279
node.inputs[29].default_value = (1.0, 1.0, 1.0)
node.inputs[30].default_value = 0.0
node.inputs[31].default_value = 1.0
...
node.inputs[37].default_value = 100.0
node.inputs[38].default_value = 1.399999976158142
