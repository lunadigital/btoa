...
node.inputs[6].default_value = 0.10000000149011612
...
node.inputs[11].default_value = (1.0, 0.5739997029304504, 0.11499996483325958)
node.inputs[12].default_value = 1.0
node.inputs[13].default_value = (1.0, 0.5190016031265259, 0.0)
