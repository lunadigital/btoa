...
node.inputs[19].default_value = (1.0, 0.6150000095367432, 0.5210000276565552)
node.inputs[20].default_value = (1.0, 0.30000001192092896, 0.10000000149011612)
node.inputs[21].default_value = 1.0
node.inputs[22].default_value = 0.0
node.inputs[23].default_value = 0.25
node.inputs[24].default_value = (1.0, 1.0, 1.0)
node.inputs[25].default_value = 0.30000001192092896
node.inputs[26].default_value = 1.3300000429153442
