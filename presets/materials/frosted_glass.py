...
node.inputs[1].default_value = (0.800000011920929, 0.800000011920929, 0.800000011920929)
...
node.inputs[6].default_value = 0.4000000059604645
node.inputs[7].default_value = 1.5199999809265137
node.inputs[8].default_value = 0.0
node.inputs[9].default_value = 0.5
node.inputs[10].default_value = 1.0
node.inputs[11].default_value = (0.7129999995231628, 0.8180000185966492, 0.8140000104904175)
node.inputs[12].default_value = 0.0
node.inputs[13].default_value = (0.2919999957084656, 0.2919999957084656, 0.2919999957084656)
...
node.inputs[26].default_value = (0.8083878755569458, 0.8083878755569458, 0.8083878755569458)
...
node.caustics = True
node.internal_reflections = True
