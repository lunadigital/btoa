...
node.inputs[6].default_value = 0.11999999731779099
node.inputs[7].default_value = 1.3300000429153442
node.inputs[8].default_value = 0.0
node.inputs[9].default_value = 0.0
node.inputs[10].default_value = 1.0
node.inputs[11].default_value = (0.7440000176429749, 0.9399999976158142, 1.0)
node.inputs[12].default_value = 10.0
node.inputs[13].default_value = (0.06699973344802856, 0.13400056958198547, 0.49999991059303284)
node.inputs[14].default_value = 0.75
