...
node.inputs[1].default_value = (0.0430000014603138, 0.24899999797344208, 0.3569999933242798)
node.inputs[2].default_value = 0.0
node.inputs[3].default_value = 0.5
node.inputs[4].default_value = 1.0
node.inputs[5].default_value = (0.07999999821186066, 0.4560000002384186, 0.656000018119812)
...
node.inputs[26].default_value = (1.0, 1.0, 1.0)
