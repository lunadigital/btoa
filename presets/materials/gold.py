...
node.inputs[1].default_value = (0.9469999074935913, 0.7760007977485657, 0.3709999918937683)
node.inputs[2].default_value = 0.0
node.inputs[3].default_value = 1.0
node.inputs[4].default_value = 1.0
node.inputs[5].default_value = (1.0, 0.981999933719635, 0.7529998421669006)
